...
def _parse_args(parser: "HfArgumentParser", args: Optional[Dict[str, Any]] = None) -> Tuple[Any]:
    ...
    if len(sys.argv) == 2 and sys.argv[1].endswith(".yaml"):
        logger.info('{} \n _parse_args sys.argv is {} \n{}\n\n'.format('*' * 20, sys.argv, '*' * 20))
        parser_result = parser.parse_yaml_file(os.path.abspath(sys.argv[1]))
        logger.info('{} \n parser_result sys.argv is {} \n{}\n\n'.format('*' * 20, parser_result, '*' * 20))
